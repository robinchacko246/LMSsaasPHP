...
class StoreController extends Controller
{
    ...
    public function storeSlug($slug)
    {
        ...
        $featured_course = Course::where('store_id',$store->id)->where('featured_course', 'on')->orderBy('id', 'DESC')->limit(4)->get();
        ...
        return view('storefront.index', compact('featured_course', 'special_offer_courses', 'categories', 'demoStoreThemeSetting', 'store', 'settings', 'categories', 'total_item', 'courses', 'page_slug_urls', 'blog', 'slug'));
    }
    ...
    public function StoreBlog($slug)
    {
        ...
        return view('storefront.store_blog', compact('slug', 'demoStoreThemeSetting', 'store', 'page_slug_urls', 'blogs'));
    }
    ...
    public function StoreBlogView($slug, $blog_id)
    {
        ...
        return view('storefront.store_blog_view', compact('blog', 'demoStoreThemeSetting', 'slug', 'store', 'page_slug_urls', 'blogs', 'socialblogs', 'socialblogsarr'));
    }
    ...
    public function productView($slug, $id)
    {
        ...
        return view('storefront.view', compact('products', 'store', 'user_count', 'avg_rating', 'products_image', 'total_item', 'product_ratings', 'store_setting', 'product_variant_names', 'page_slug_urls', 'blog'));
    }
    ...
    public function StoreCart($slug)
    {
        ...
        return view('storefront.cart', compact('demoStoreThemeSetting', 'products', 'store', 'page_slug_urls', 'blog', 'slug'));
    }
    ...
    public function userAddress($slug)
    {
        ...
        if(!empty($products))
        {
            ...
            return view('storefront.shipping', compact('products', 'store', 'taxArr', 'total_item', 'cust_details', 'locations', 'shippings', 'page_slug_urls', 'blog'));
        }
        else
        {
            return redirect()->back()->with('error', __('Please add to product into cart.'));
    ...
    public function userPayment($slug)
    {
        ...
        if(!empty($products))
        {
            if(!empty($cust_details))
            {
                ...
                return view('storefront.payment', compact('products', 'order', 'cust_details', 'store', 'taxArr', 'total_item', 'encode_product', 'url', 'shipping_price', 'page_slug_urls', 'store_payments', 'blog'));
            }
            else
            {
    ...
    public function userorder($slug, $order_id)
    {
        ...
        return view('storefront.userorder', compact('slug', 'student_data', 'discount_price', 'order', 'store', 'grand_total', 'order_products', 'sub_total', 'order_id'));
    }
    ...
    public function ViewCourse($slug, $course_id)
    {
        ...
        return view('storefront.viewcourse', compact('category_name', 'more_by_category', 'header_first', 'demoStoreThemeSetting', 'faqs', 'blog', 'slug', 'tutor_id', 'tutor_count_rating', 'avg_tutor_rating', 'tutor_ratings', 'course_ratings', 'avg_rating', 'store', 'page_slug_urls', 'course', 'chapter', 'header', 'tutor_course_count', 'tutor_course_rel', 'user_count'));
    }
    ...
    public function checkout($slug, $courses_id, $total)
    {
        ...
        if(!empty(Auth::guard('students')->user()))
        {
            ...
            if($total > 0)
            {
                return view('storefront.checkout', compact('order_id', 'demoStoreThemeSetting', 'order', 'encode_product', 'store_payments', 'blog', 'slug', 'course', 'page_slug_urls', 'store'));
            }
            else
            {
                if($products)
        ...
        else
        {
            ...
            return view('storefront.user.login', compact('blog', 'demoStoreThemeSetting', 'slug', 'store', 'page_slug_urls', 'is_cart'));
        }
    }
    ...
    public function studentHome($slug)
    {
        ...
        return view('storefront.student.index', compact('purchased_course', 'demoStoreThemeSetting', 'blog', 'slug', 'store', 'page_slug_urls'));
    }
    ...
    public function wishlistpage($slug)
    {
        ...
        else
        {
            ...
            return view('storefront.student.wishlist', compact('blog', 'demoStoreThemeSetting', 'slug', 'page_slug_urls', 'page_slug_urls', 'store', 'courses'));
        }
    }
    ...
    public function fullscreen($slug, $course_id, $chapter_id = null, $type = null)
    {
        ...
        return view('storefront.fullscreen', compact('practices_files', 'ChapterStatuss', 'demoStoreThemeSetting', 'blog', 'page_slug_urls', 'progress', 'previous', 'next', 'current_chapter', 'chapter_id', 'course_id', 'headers', 'store', 'courses', 'slug', 'last_next', 'last_previous', 'cer_download','cs_incomplete'));
    }
    ...
    public function slack(Request $request)
    {
        ...
        $post['zoom_meeting_notificaation'] = $request->has('zoom_meeting_notificaation')?$request->input('zoom_meeting_notificaation'):0;
    ...
    public function certificatedl(Request $request)
    {
        ...
        $course   = Course::all();
        $stud     = Student::all();        
        // $user   = Student::where('id', $objUser->id)->where('id',$stud[0]->store_id)->get();
