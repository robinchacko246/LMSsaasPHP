...
class StudentLoginController extends Controller
{
    ...
    public function showLoginForm($slug)
    {
        ...
        return view('storefront.user.login', compact('blog', 'demoStoreThemeSetting', 'store', 'slug', 'page_slug_urls'));
    }
    ...
    public function profile($slug, $id)
    {
        ...
        return view('storefront.student.profile', compact('blog', 'demoStoreThemeSetting', 'slug', 'store', 'page_slug_urls', 'userDetail'));
    }
