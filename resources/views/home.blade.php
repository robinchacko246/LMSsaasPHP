                ...
                <div class="col-lg-3">
                    <div class="card card-stats bg-gradient-primary border-0 hover-shadow-lg hover-translate-y-n3 mb-4 ml-lg-0">
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <h6 class="text-white font-bold-700 mb-1">{{__('Total Course')}}</h6>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <span class="h5 font-weight-bold text-white mb-0">{{ Utility::priceFormat($totle_sale)}}</span>
                                </div>
                                <div class="col-auto">
                ...
                <div class="col-xl-12 col-md-6">
                    <div class="card card-fluid">
                        <div class="card-header border-0">
                            <h6 class="mb-0 float-left">{{__('Top Course')}}</h6>
                            <span class="float-right mb-0">{{__('Top 5 Courses')}}</span>
                        </div>
                ...
                <div class="col-xl-12 col-md-6">
                    <div class="card card-fluid">
                        <div class="card-header border-0">
                            ...
                            <span class="float-right mb-0">{{__('Top 5 Recent Orders')}}</span>
                        </div>
                        <div class="table-responsive">
                            <table class="table align-items-center">
                                <thead>
