...
@section('title')
    <div class="d-inline-block">
        <h5 class="h4 d-inline-block text-white font-weight-bold mb-0 ">{{__('Zoom Meeting Calender')}}</h5>
    </div>
@endsection
        ...
        <div class="page-title">
            <div class="row justify-content-end align-items-center">
                <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                    <div class="all-button-box d-flex justify-content-end calender_btn">
                        <div class="all-button-box text-center">
                            <a href="{{ route('zoom-meeting.index') }}" class="btn btn-sm btn-white btn-icon-only rounded-circle ml-1 shadow-sm"><i class="fas fa-list"></i> </a>
                            <br>
                            <p class="m-0">
                            {{__('List View')}}
                            </p>
                        ...
                        @if(\Auth::user()->type == 'Owner')
                            <div class="all-button-box text-center ml-3">
                                <a href="#" data-url="{{ route('zoom-meeting.create') }}" data-ajax-popup="true" data-title="{{__('Create Zoom Meeting')}}" class="btn btn-sm btn-white btn-icon-only rounded-circle ml-1 shadow-sm">
            ...
            <div class="col-md-12 mt-3">
                <div class="row justify-content-between align-items-center">
                    <div class="col d-flex align-items-center ">
                        <h5 class="fullcalendar-title h4 d-inline-block font-weight-400 text-white mb-0">{{__('Calendar')}}</h5>
                    </div>
